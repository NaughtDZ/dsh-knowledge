...
const TOOL_DESCRIPTION = 'Search the knowledge bases enabled for a workspace (or a specific knowledge base, or all bases) and return the '
...
export function registerKnowledgeTool(ctx, engine) {
